...
import 'package:latihan_uts/latihan/edit_karyawan.dart';
import 'package:latihan_uts/latihan_model/lat_model_karyawan.dart';
  ...
  Future<void> fetchData() async {
    try {
      final response = await http.get(
          Uri.parse("http://10.127.249.175/edukasi_server/getPegawai.php"));
                                    ...
                                    actions: <Widget>[
                                      ...
                                      TextButton(
                                        onPressed: () {
                                          ...
                                          http.post(
                                            Uri.parse('http://10.127.249.175/edukasi_server/deletePegawai.php'),
                ...
                ElevatedButton(
                  onPressed: () {
                    if (keyForm.currentState?.validate() == true) {
                      ...
                      http.post(
                        Uri.parse('http://10.127.249.175/edukasi_server/simpanPegawai.php'),
                        body: dataKaryawan,
                      ).then((response) {
                        // Memeriksa respons dari server
                        if (response.statusCode == 200) {
